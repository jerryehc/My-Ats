...
public class Order implements Serializable {
    ...
    public String toString(){
        ...
        add(sb,"clientId", m_clientId );
        add(sb,"orderId", m_orderId );
        add(sb,"permId", m_permId );
        add(sb,"parentId", m_parentId );
        add(sb,"action", m_action );
        add(sb,"totalQuantity", m_totalQuantity );
        add(sb,"orderType", m_orderType );
        add(sb,"lmtPrice", m_lmtPrice );
        add(sb,"auxPrice", m_auxPrice );
        add(sb,"tif", m_tif );
        add(sb,"faGroup", m_faGroup );
        add(sb,"faMethod", m_faMethod );
        add(sb,"faPercentage", m_faPercentage );
        add(sb,"faProfile", m_faProfile );
        add(sb,"transmit", m_transmit );
        add(sb,"whatIf", m_whatIf );
        add(sb,"openClose", m_openClose );
        add(sb,"shortSaleSlot", m_shortSaleSlot );
